      ...
      <div className="w-full">
        <div className="bg-white flex dark:bg-gray-800 rounded-xl shadow-md p-6 transition-colors">
          ...
          <button
            ...
            className="px-4 mx- py-2 border-2 text-white border-blue-600 bg-blue-600  dark:text-white rounded hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500 transition-all"
          >
            Click here
          </button>
        </div>
