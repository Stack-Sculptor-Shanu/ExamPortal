...
import { FaReact, FaNodeJs, FaDatabase, FaHtml5, FaCss3Alt, FaJsSquare, FaTerminal } from 'react-icons/fa'; // Importing icons
      ...
      <section className="mb-16 px-5 md:px-20">
        ...
        <div className="grid md:grid-cols-3 gap-8" onClick={handleCardClick}>
          ...
          <motion.div className="bg-white shadow-lg rounded-lg overflow-hidden" whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
            <img src="https://media.giphy.com/media/Jq0GVxoPkwBDG9h0YX/giphy.gif" alt="ReactJS" className="w-full h-40 object-cover" />
            <div className="p-5">
          ...
          <motion.div className="bg-white shadow-lg rounded-lg overflow-hidden" whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
            ...
            <div className="p-5">
              <h3 className="text-xl font-semibold text-gray-800">NodeJS</h3>
          ...
          <motion.div className="bg-white shadow-lg rounded-lg overflow-hidden" whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
            ...
            <div className="p-5">
              <h3 className="text-xl font-semibold text-gray-800">ExpressJS</h3>
